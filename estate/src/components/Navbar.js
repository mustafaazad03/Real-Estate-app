		...
		<nav className="border-gray-200 px-2">
			<div className="container mx-auto flex flex-wrap items-center justify-between">
				...
				<div className={(show)?"lg:flex justify-between items-center w-full lg:w-auto lg:order-1":"hidden lg:flex justify-between items-center w-full lg:w-auto lg:order-1"}  id="mobile-menu-3">
					<div className="flex-col lg:flex-row flex lg:space-x-8 mt-4 lg:mt-0 lg:text-sm lg:font-medium">
						...
						<div className="lg:mt-[0.9rem] ml-[43vw] lg:ml-0 lg:space-x-2 flex lg:flex-row space-y-2 lg:space-y-0 flex-col w-[90vw] lg:absolute lg:right-4 lg:w-auto">
